...
BOBLIGHT_FUNCTION(int,         boblight_getlightnr,       (void* vpboblight, int x, int y));
...
BOBLIGHT_FUNCTION(void,        boblight_addbitmap,        (void* vpboblight, unsigned char* bmp, int xsize, int ysize));
