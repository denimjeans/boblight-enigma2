...
BOBLIGHT_OPTION(speed,         float,  0.0, 100.0, 60.0,  m_speed,         m_speed = Clamp(m_speed, 0.0, 100.0); send = true;)
BOBLIGHT_OPTION(autospeed,     float,  0,   100.0, 0.0,    m_autospeed,     m_autospeed = Max(m_autospeed, 0.0);)
BOBLIGHT_OPTION(interpolation, bool,   false, true, true, m_interpolation, send = true;)
